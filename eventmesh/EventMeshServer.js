...
class EventMeshServer {
  ...
  getOperationFolderName(opts) {
    ...
    assert.ok(opts.operationId, `Property 'operationId' is required to get operation folder name`);
    return `${opts.operationName}/${opts.operationType}/${opts.resourceId}/${opts.operationId}`;
  }
