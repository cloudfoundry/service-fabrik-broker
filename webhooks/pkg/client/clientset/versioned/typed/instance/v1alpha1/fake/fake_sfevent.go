...
func (c *FakeSfevents) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Sfevent, err error) {
	obj, err := c.Fake.
...
func (c *FakeSfevents) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SfeventList, err error) {
	obj, err := c.Fake.
...
func (c *FakeSfevents) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeSfevents) Create(ctx context.Context, sfevent *v1alpha1.Sfevent, opts v1.CreateOptions) (result *v1alpha1.Sfevent, err error) {
	obj, err := c.Fake.
...
func (c *FakeSfevents) Update(ctx context.Context, sfevent *v1alpha1.Sfevent, opts v1.UpdateOptions) (result *v1alpha1.Sfevent, err error) {
	obj, err := c.Fake.
...
func (c *FakeSfevents) UpdateStatus(ctx context.Context, sfevent *v1alpha1.Sfevent, opts v1.UpdateOptions) (*v1alpha1.Sfevent, error) {
	obj, err := c.Fake.
...
func (c *FakeSfevents) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(sfeventsResource, c.ns, name, opts), &v1alpha1.Sfevent{})

	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeSfevents) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(sfeventsResource, c.ns, listOpts)
...
func (c *FakeSfevents) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Sfevent, err error) {
	obj, err := c.Fake.
