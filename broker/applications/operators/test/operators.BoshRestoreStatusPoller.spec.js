...
describe('operators', function() {
  describe('BoshRestoreStatusPoller', function() {
    const BoshRestoreStatusPoller = proxyquire('../src/bosh-restore-operator/BoshRestoreStatusPoller', {
    ...
    describe('#getStatus', function() {
      ...
      it('should handle errors in any of the child methods', () => {
        ...
        let patchResourceStub = sandbox.stub(apiServerClient, 'patchResource').resolves();
        let restoreResource = {
          metadata: {
            name: restoreGuid
          },
    ...
    describe('#_handleBoshStartStopPolling', function() {
      ...
      beforeEach(() => {
        sandbox = sinon.createSandbox();
        getTaskStub = sandbox.stub(director, 'getTask');
