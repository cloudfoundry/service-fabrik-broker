    ...
    return Promise
      ...
      .then(metadata => this
        ...
        .then(restoreOptions => {
          ...
          const service = this.getService(serviceId);
          const isBoshRestoreEnabled = _.get(service, 'restore_operation.type') === 'defaultboshrestore' ? true : false ;
          restoreType = isBoshRestoreEnabled ? CONST.APISERVER.RESOURCE_TYPES.DEFAULT_BOSH_RESTORE: CONST.APISERVER.RESOURCE_TYPES.DEFAULT_RESTORE;
          return lockManager.lock(req.params.instance_id, {
              lockedResourceDetails: {
