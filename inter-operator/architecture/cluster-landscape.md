...
| Cluster Landscape Scenario | Scenario Visualization | [Scalability](#scalability) | [Networking Complexity](#networking-complexity) for Data-plane | [Networking Complexity](#networking-complexity) for Control-plane | [Security Isolation](#security-isolation) per Customer | [Security Isolation](#security-isolation) per Service Instance | [Resource Utilization](#resource-utilization) | [Cluster Topology](#cluster-topology) | [Cluster Maintenance](#cluster-maintenance) | [Cluster Disposability](#cluster-disposability) | [SLA](#sla) | [Cross-platform Consumption](#cross-platform-consumption) | [Service Administration and Life Cycle Management](#service-administration-and-life-cycle-management) | Service Instance Sharing |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Managed Clusters per Service Type | ![Managed Clusters per Service Type](images/managed-clusters-per-service-type.png) | Unlimited | Complex | Complex | High with [proper mitigation](https://github.wdf.sap.corp/CPonK8s/k8s-native-services-concept/blob/master/README.md#security) | High with [proper mitigation](https://github.wdf.sap.corp/CPonK8s/k8s-native-services-concept/blob/master/README.md#security) | High | Easy to enforce | Independently manageable | Possibly high | Possible | Possible | Possible centrally | Similar to private service instances |
| Managed Clusters shared among Service Types | ![Managed Clusters shared among Service Types](images/managed-clusters-shared-among-service-types.png) | Unlimited | Complex | Complex | High with [proper mitigation](https://github.wdf.sap.corp/CPonK8s/k8s-native-services-concept/blob/master/README.md#security) | High with [proper mitigation](https://github.wdf.sap.corp/CPonK8s/k8s-native-services-concept/blob/master/README.md#security) | High | Enforcing requires co-ordination between service types | Requires co-ordination between service types | Possibly high | Possible | Possible | Possible centrally | Similar to private service instances |
| Service Instances in consuming Cluster | ![Service Instances in consuming Cluster](images/service-instances-in-consuming-cluster.png) | Limited to the hosting cluster but the need for scalability might be less | Simple | Complex | High | High with [proper mitigation](https://github.wdf.sap.corp/CPonK8s/k8s-native-services-concept/blob/master/README.md#security) and security isolation requirement might be less | High | Hard to enforce | Requires co-ordination between the services and apps running in the hosting cluster | Low | Hard because of admin access to the cluster for the consumer | Restricted to Kubernetes | Requires co-ordination with the consuming cluster | Difficult |
| Managed per-Customer Shadow Clusters per Service Type in separate IaaS accounts | ![Managed per-Customer Shadow Clusters per Service Type in separate IaaS accounts](images/managed-per-customer-shadow-clusters-per-service-type-separate-iaas-account.png) | Unlimited | Peering? | Complex | High | High with [proper mitigation](https://github.wdf.sap.corp/CPonK8s/k8s-native-services-concept/blob/master/README.md#security) | High if there are a large number of service instances of a given service type for a given customer | Easy to enforce | Independently manageable | Possibly high | Possible | Possible | Possible centrally | Possibly similar to private service instances |
| Managed per-Customer Shadow Clusters shared among Service Types in separate IaaS accounts | ![Managed per-Customer Shadow Clusters shared among Service Types in separate IaaS accounts](images/managed-per-customer-shadow-clusters-shared-among-service-types-separate-iaas-account.png) | Unlimited | Peering? | Complex | High | High with [proper mitigation](https://github.wdf.sap.corp/CPonK8s/k8s-native-services-concept/blob/master/README.md#security) and security isolation requirement might be less | High if there are a large number of service instances for the customer | Enforcing requires co-ordination between service types | Requires co-ordination between service types | Possibly high | Possible | Possible | Possible centrally | Possibly similar to private service instances |
| Managed per-Customer Shadow Clusters per Service Type in shared IaaS accounts | ![Managed per-Customer Shadow Clusters per Service Type in shared IaaS accounts](images/managed-per-customer-shadow-clusters-per-service-type-shared-iaas-account.png) | Unlimited | Simple | Complex | High | High with [proper mitigation](https://github.wdf.sap.corp/CPonK8s/k8s-native-services-concept/blob/master/README.md#security) | High if there are a large number of service instances of a given service type for a given customer | Easy to enforce | Independently manageable | Possibly high | Possible | Possible | Possible centrally | Difficult |
| Managed per-Customer Shadow Clusters shared among Service Types in shared IaaS accounts | ![Managed per-Customer Shadow Clusters shared among Service Types in shared IaaS accounts](images/managed-per-customer-shadow-clusters-shared-among-service-types-shared-iaas-account.png) | Unlimited | Simple | Complex | High | High with [proper mitigation](https://github.wdf.sap.corp/CPonK8s/k8s-native-services-concept/blob/master/README.md#security) and security isolation requirement might be less | High if there are a large number of service instances for the customer | Enforcing requires co-ordination between service types | Requires co-ordination between service types | Possibly high | Possible | Possible | Possible centrally | Difficult |
