...
class ServiceFabrikApiController extends BaseController {
  ...
  scheduleBackup(req, res) {
    ...
    const data = _
      ...
      .value();
    return this.cloudController.getServiceInstanceDetails(req.params.instance_id)
      .then(instance => {
        _.chain(data)
          .set('instance_name', instance.name)
          .set('service_name', instance.service_name)
          .set('service_plan_name', instance.service_plan_name)
          .set('space_name', instance.space_name)
          .set('organization_name', instance.organization_name)
          .set('organization_guid', instance.organization_guid)
          .value();
