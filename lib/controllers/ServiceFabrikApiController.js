  ...
  verifyTenantPermission(req, res) {
    ...
    return Promise
      .try(() => {
        ...
        const platform = _.get(req, 'body.context.platform') || _.get(req, 'query.platform') || CONST.CONSUMING_ENVIRONMENT.CF;
        ...
        const tenant_id = _.get(req, 'body.space_guid') || _.get(req, 'query.space_guid') ||
          (platform ? (_.get(req, 'query.tenant_id') || _.get(req, 'body.context.space_guid') || _.get(req, 'body.context.namespace')) :
            undefined);
        if (tenant_id) {
