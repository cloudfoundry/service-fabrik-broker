  ...
  show(req, res) {
    ...
    return req.instance
      ...
      .then(info => {
        ...
        let additional_info = {};
        if (req.instance.plan.manager.settings.dashboard_template_path) {
          additional_info = yaml.safeLoad(_.template(fs.readFileSync(req.instance.plan.manager.settings.dashboard_template_path))(info));
        }
        info = _.assign({
