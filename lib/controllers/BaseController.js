...
class BaseController {
  ...
  assignInstance(req, res) {
    ...
    const operation = utils.decodeBase64(_.get(req, 'query.operation') || 'bnVsbA==');
  ...
  validateRequest(req, res) {
    const httpMethod = _.get(req, 'method');
    ...
    if (_.includes([CONST.HTTP_METHOD.PUT, CONST.HTTP_METHOD.POST, CONST.HTTP_METHOD.PATCH], httpMethod) && (!_.get(req.body, 'space_guid') || !_.get(req.body, 'organization_guid'))) {
