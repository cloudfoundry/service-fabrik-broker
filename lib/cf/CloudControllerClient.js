...
class CloudControllerClient extends HttpClient {
  ...
  getService(guid, options) {
    return this.getResource(`/v2/services/${guid}`, options);
  }
  ...
  getServiceInstanceDetails(instance_guid) {
    return this.getServiceInstance(instance_guid)
      .then(instance => {
        return Promise
          .all([
            this.getService(instance.entity.service_guid),
            this.getServicePlan(instance.entity.service_plan_guid),
            this.getSpace(instance.entity.space_guid)
          ])
          .spread((service, plan, space) => {
            return _
              .chain({})
              .set('name', instance.entity.name)
              .set('service_name', service.entity.label)
              .set('service_plan_guid', instance.entity.service_plan_guid)
              .set('space_guid', instance.entity.space_guid)
              .set('service_plan_name', plan.entity.name)
