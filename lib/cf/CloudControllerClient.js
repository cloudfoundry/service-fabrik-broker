...
class CloudControllerClient extends HttpClient {
  ...
  getSpaceGuid(instance_guid, options) {
    return this.getServiceInstance(instance_guid, options)
      .then(instance => instance.entity.space_guid);
  }
  getOrgGuid(space_guid, options) {
    return this.getResource(`/v2/spaces/${space_guid}`, options)
      .then(org => org.entity.organization_guid);
  }
