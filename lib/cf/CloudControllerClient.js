    ...
    return this.getServiceInstance(instance_guid)
      .then(instance => {
        const data = {
          ...
          service_plan_guid: instance.entity.service_plan_guid,
          space_guid: instance.entity.space_guid
        };
        return Promise
          .all([
            this.getServicePlan(data.service_plan_guid),
            this.getSpace(data.space_guid)
          ])
          .spread((plan, space) => {
            _.chain(data)
