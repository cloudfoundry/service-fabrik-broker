...
class VirtualHostManager extends BaseManager{
    ...
    deleteVirtualHost(deploymentName, guid){
        ...
        return this.getDeploymentIps(deploymentName)
          ...
          .tap(credentials => this.deleteVirtualHostInstanceToDeploymentRelation(deploymentName, guid))
          .catch(err => {
    ...
    saveVirtualHostInstanceToDeploymentRelation(deploymentName, id) {
        return this.mapper
          .createOrUpdateDeploymentProperty(deploymentName, `virtual_host_instance-${id}`, JSON.stringify({}))
    ...
    deleteVirtualHostInstanceToDeploymentRelation(deploymentName, id) {
        return this.mapper
          .deleteDeploymentProperty(`virtual_host_instance-${id}`)
          .catchThrow(BadRequest, new VirtualHostInstanceToDeploymentRelationAlreadyExists(deploymentName, id));
    }
