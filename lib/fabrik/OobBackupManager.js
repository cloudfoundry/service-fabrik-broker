...
class OobBackupManager {
  ...
  getAgentFromAgentProperties(agentProperties) {
    return {
      version: agentProperties.version || agentProperties.agent.version || '1',
      provider: agentProperties.provider || agentProperties.agent.provider,
      auth: {
        username: agentProperties.username || agentProperties.agent.username,
        password: agentProperties.password || agentProperties.agent.password
      }
    };
  }
