    ...
    return this
      ...
      .then(manager => {
        ...
        return Promise
          ...
          .then(context => {
            const platformManager = !context ? undefined : (context.platform === CONST.PLATFORM.CF ?
              new CfPlatformManager(instance_id, manager, context) : (context.platform === CONST.PLATFORM.K8S ?
