      ...
      .spread((deploymentNames, pgInstances) => {
        ...
        return this.updateUsedIpsInMongo(ipUsedByInstanceMap)
          .then((usedIpMap) => {
            ...
            logger.info(`Number of indices to be reserved  - ${numberOfIndicesToBeReserved} - ips to be reserved - ${noOfIpsToBeReserved} in network ${this.networkName}`);
