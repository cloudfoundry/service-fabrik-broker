...
class DirectorInstance extends BaseInstance {
  constructor(guid, manager, platformManager) {
    ...
    this.platformManager = platformManager ? platformManager : undefined;
  }
    ...
    return this.manager.director.getDeploymentNameForInstanceId(this.guid)
      ...
      .then(context => {
        if (context.platform === CONST.CONSUMING_ENVIRONMENT.CF) {
          return new CfPlatformManager(this.guid, this.manager);
        } else if (context.platform === CONST.CONSUMING_ENVIRONMENT.K8S) {
          return new K8sPlatformManager(this.guid, this.manager);
        }
      })
  ...
  initialize(operation) {
    return Promise
      ...
      .tap(() => {
        //TODO: This still has coupling with space guid as it calls ensureSpaceGuid. 
      ...
      .try(() => {
        if (operation.context.platform === CONST.CONSUMING_ENVIRONMENT.CF) {
          ...
          case 'create':
            ...
            return this
              .createSecurityGroup(this.manager.getTenantGuid(operation.context))
