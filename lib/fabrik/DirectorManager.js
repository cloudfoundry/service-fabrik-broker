...
class DirectorManager extends BaseManager {
      ...
      .try(() => {
        ...
        case CONST.OPERATION_TYPE.UPDATE:
          ...
          return this
            ...
            .then(() => this.executePreUpdateActions(deploymentName, actionContext))
            .tap(response => {
              logger.info('PreUpdate action response is ...', response);
              preUpdateResponse = response;
            });
  ...
  executePreUpdateActions(deploymentName, context) {
    _.assign(context, {
