...
class DirectorManager extends BaseManager {
  ...
  createOrUpdateDeployment(deploymentName, params, args) {
    ...
    return Promise
      ...
      .then(() => action === CONST.OPERATION_TYPE.CREATE ?
        this.executeActions(CONST.SERVICE_LIFE_CYCLE.PRE_CREATE, deploymentName, params, args) :
        this.executeActions(CONST.SERVICE_LIFE_CYCLE.PRE_UPDATE, deploymentName, params, args)
      )
  ...
  executeActions(phase, deploymentName, params, args) {
    return Promise.try(() => {
  ...
  deleteDeployment(deploymentName) {
    ...
    return Promise
      ...
      .then(() => this.executeActions(CONST.SERVICE_LIFE_CYCLE.PRE_DELETE, deploymentName))
