...
class VirtualHostInstanceToDeploymentRelationAlreadyExists extends BadRequest {
  constructor(deployment, id) {
    super(`Virtual host instance with ID ${id} already exists on deployment ${deployment}`);
  }
}
exports.VirtualHostInstanceToDeploymentRelationAlreadyExists = VirtualHostInstanceToDeploymentRelationAlreadyExists;
...
// Errors specific to virtualhost manager
class RabbitMQServiceInstanceNameNotFound extends BadRequest {
  constructor(name) {
    super(`Could not find RabbitMQ Service Instance with Name ${name} that supports multi tenancy`);
  }
}
exports.RabbitMQServiceInstanceNameNotFound = RabbitMQServiceInstanceNameNotFound;