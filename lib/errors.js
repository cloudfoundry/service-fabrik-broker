...
class ForbiddenManifestChangesError extends HttpServerError {
  constructor(message) {
    super(500, 'Error due to changes in forbidden sections of the manifest', message);
  }
}
exports.ForbiddenManifestChangesError = ForbiddenManifestChangesError;
