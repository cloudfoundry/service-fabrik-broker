...
class MultiTenantServiceInstanceNameNotFound extends BadRequest {
  constructor(name, service) {
    super(`Could not find ${service} Service Instance with Name ${name} that supports multi tenancy`);
  }
}
exports.MultiTenantServiceInstanceNameNotFound = MultiTenantServiceInstanceNameNotFound;