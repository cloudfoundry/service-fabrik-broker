...
class DeploymentAlreadyLocked extends Conflict {
  constructor(deploymentName, lockInfo) {
    super(`Deployment ${deploymentName} already locked by ${lockInfo.username} at ${lockInfo.createdAt} for ${lockInfo.lockForOperation}`);
  }
}
