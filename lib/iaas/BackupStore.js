...
class Filename {
  ...
  parse(filename) {
    ...
    return _
      ...
      .assign(data)
      .tap(filenameObject => {
        if (filenameObject.started_at && this.keys.exclude_file_with_root_value !== _.get(filenameObject,this.root)) {
  ...
  isValidTimeStamp(timestamp) {
    var timeStampRegex = new RegExp(`^[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|[12][0-9]|3[01])T(0[0-9]|1[0-9]|2[0-4])-([0-5][0-9])-([0-5][0-9])Z$`);
