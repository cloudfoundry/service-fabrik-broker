...
exports.isSameSkuUpdate = isSameSkuUpdate;
exports.getSkuNameForPlan = getSkuNameForPlan;
...
function isSameSkuUpdate(params, catalog) {
  return _.get(params, 'previous_values.plan_id') === undefined || _.get(params, 'plan_id') === undefined || getSkuNameForPlan(_.find(catalog.plans, ['id', _.get(params, 'previous_values.plan_id')]).name) === getSkuNameForPlan(_.find(catalog.plans, ['id', _.get(params, 'plan_id')]).name);
}

function getSkuNameForPlan(planName) {
