...
exports.nullifyEmptyArrayOfArray = nullifyEmptyArrayOfArray;
...
function nullifyEmptyArrayOfArray(input) {
  if (input instanceof Array) {
    if (input.length === 1 && input[0] instanceof Array && input[0].length === 0) {
      return null;
    }
  }
  return input;
