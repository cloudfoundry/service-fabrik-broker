...
class BackupReportManager {
  static createInstanceRecord(instance_id, start_time, end_time) {
    return Promise
      .all([
      ...
      .spread((triggeredBackups, succeededBackups, failedBackups) => {
        ...
        const summary = {
          ...
          threeBackupFailureCount: threeBackupFailureCount
        };
  ...
  static getBackupSuccessRecord(instance_id, start_time, end_time) {
    const match = {
      eventName: 'create_backup',
      instanceId: instance_id,
      metric: 0,
  ...
  static getBackupfailureRecord(instance_id, start_time, end_time) {
    const match = {
      eventName: 'create_backup',
      instanceId: instance_id,
      metric: 1,
