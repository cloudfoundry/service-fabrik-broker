...
| ---:| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ![Managed Clusters per Service Type](images/managed-clusters-per-service-type.png) | Unlimited | Complex | High with [proper mitigation](https://github.wdf.sap.corp/CPonK8s/k8s-native-services-concept/blob/master/README.md#security) | High | Easy to enforce | Independently manageable | Possibly high | Possible | Possible | Possible centrally |
