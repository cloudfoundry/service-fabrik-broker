...
func TestReconcile(t *testing.T) {
	...
	g.Expect(c.Get(context.TODO(), _getKey(instance1), instance1)).NotTo(gomega.HaveOccurred())
	...
	g.Expect(utils.DrainAllRequests(requests, timeout)).NotTo(gomega.BeZero())
	g.Expect(c.Get(context.TODO(), _getKey(instance2), instance2)).NotTo(gomega.HaveOccurred())
	...
	g.Expect(utils.DrainAllRequests(requests, timeout)).NotTo(gomega.BeZero())
	g.Expect(c.Get(context.TODO(), _getKey(instance3), instance3)).NotTo(gomega.HaveOccurred())
	...
	g.Expect(utils.DrainAllRequests(requests, timeout)).NotTo(gomega.BeZero())
	g.Expect(c.Get(context.TODO(), _getKey(instance4), instance4)).NotTo(gomega.HaveOccurred())
	...
	g.Expect(utils.DrainAllRequests(requests, timeout)).NotTo(gomega.BeZero())
	g.Expect(c.Get(context.TODO(), _getKey(instance5), instance5)).NotTo(gomega.HaveOccurred())
