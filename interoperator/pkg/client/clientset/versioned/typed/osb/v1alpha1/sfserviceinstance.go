...
// SFServiceInstancesGetter has a method to return a SFServiceInstanceInterface.
...
type SFServiceInstanceInterface interface {
	...
	UpdateStatus(*v1alpha1.SFServiceInstance) (*v1alpha1.SFServiceInstance, error)
...
// sFServiceInstances implements SFServiceInstanceInterface
type sFServiceInstances struct {
	client rest.Interface
	ns     string
}

// newSFServiceInstances returns a SFServiceInstances
func newSFServiceInstances(c *OsbV1alpha1Client, namespace string) *sFServiceInstances {
	return &sFServiceInstances{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *sFServiceInstances) List(opts v1.ListOptions) (result *v1alpha1.SFServiceInstanceList, err error) {
	...
	result = &v1alpha1.SFServiceInstanceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("sfserviceinstances").
...
func (c *sFServiceInstances) UpdateStatus(sFServiceInstance *v1alpha1.SFServiceInstance) (result *v1alpha1.SFServiceInstance, err error) {
	result = &v1alpha1.SFServiceInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sfserviceinstances").
