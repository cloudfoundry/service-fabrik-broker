...
var sfservicebindingsResource = schema.GroupVersionResource{Group: "osb.servicefabrik.io", Version: "v1alpha1", Resource: "sfservicebindings"}

var sfservicebindingsKind = schema.GroupVersionKind{Group: "osb.servicefabrik.io", Version: "v1alpha1", Kind: "SFServiceBinding"}
...
func (c *FakeSFServiceBindings) UpdateStatus(sFServiceBinding *v1alpha1.SFServiceBinding) (*v1alpha1.SFServiceBinding, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(sfservicebindingsResource, "status", c.ns, sFServiceBinding), &v1alpha1.SFServiceBinding{})
