...
import (
	...
	"github.com/cloudfoundry-incubator/service-fabrik-broker/interoperator/pkg/client/clientset/versioned/scheme"
	serializer "k8s.io/apimachinery/pkg/runtime/serializer"
	rest "k8s.io/client-go/rest"
)

type OsbV1alpha1Interface interface {
	RESTClient() rest.Interface
	SFPlansGetter
	SFServicesGetter
	SFServiceBindingsGetter
	SFServiceInstancesGetter
}

// OsbV1alpha1Client is used to interact with features provided by the osb.servicefabrik.io group.
type OsbV1alpha1Client struct {
	restClient rest.Interface
}

func (c *OsbV1alpha1Client) SFPlans(namespace string) SFPlanInterface {
	return newSFPlans(c, namespace)
}

func (c *OsbV1alpha1Client) SFServices(namespace string) SFServiceInterface {
	return newSFServices(c, namespace)
}

func (c *OsbV1alpha1Client) SFServiceBindings(namespace string) SFServiceBindingInterface {
	return newSFServiceBindings(c, namespace)
}

func (c *OsbV1alpha1Client) SFServiceInstances(namespace string) SFServiceInstanceInterface {
	return newSFServiceInstances(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*OsbV1alpha1Client, error) {
	...
	return &OsbV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new OsbV1alpha1Client for the given config and
...
func New(c rest.Interface) *OsbV1alpha1Client {
	return &OsbV1alpha1Client{c}
}
