...
var sfplansResource = schema.GroupVersionResource{Group: "osb.servicefabrik.io", Version: "v1alpha1", Resource: "sfplans"}

var sfplansKind = schema.GroupVersionKind{Group: "osb.servicefabrik.io", Version: "v1alpha1", Kind: "SFPlan"}
...
func (c *FakeSFPlans) UpdateStatus(sFPlan *v1alpha1.SFPlan) (*v1alpha1.SFPlan, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(sfplansResource, "status", c.ns, sFPlan), &v1alpha1.SFPlan{})
