...
func (in *PlanSpec) DeepCopyInto(out *PlanSpec) {
	*out = *in
	...
	in.RawContext.DeepCopyInto(&out.RawContext)
	return
}
...
func (in *Templates) DeepCopyInto(out *Templates) {
	*out = *in
	out.ProvisionTemplate = in.ProvisionTemplate
	out.BindTemplate = in.BindTemplate
	out.PropertiesTemplate = in.PropertiesTemplate
	return
}
