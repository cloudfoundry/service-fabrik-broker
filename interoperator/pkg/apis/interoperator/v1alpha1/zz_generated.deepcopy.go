...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServiceInstanceOptions) DeepCopyInto(out *ServiceInstanceOptions) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServiceInstanceOptions.
func (in *ServiceInstanceOptions) DeepCopy() *ServiceInstanceOptions {
	if in == nil {
		return nil
	}
	out := new(ServiceInstanceOptions)
	in.DeepCopyInto(out)
	return out
}
