...
(function (global, factory) {
  ...
  let slice = deletedIds.slice;

  let concat = deletedIds.concat;

  let push = deletedIds.push;

  let indexOf = deletedIds.indexOf;
  ...
  let Sizzle =
    ...
    (function (window) {
      ...
      function Sizzle(selector, context, results, seed) {
        let m, i, elem, nid, nidselect, match, groups, newSelector,
          ...
          then: function (/* fnDone, fnFail, fnProgress */) {
            ...
            return jQuery.Deferred(function (newDefer) {
              jQuery.each(tuples, function (i, tuple) {
                let fn = jQuery.isFunction(fns[i]) && fns[i];
  ...
  let acceptData = function (elem) {
    let noData = jQuery.noData[(elem.nodeName + ' ').toLowerCase()],
  ...
  let rleadingWhitespace = (/^\s+/);

  let nodeNames = 'abbr|article|aside|audio|bdi|canvas|data|datalist|' +
  ...
  let rformElems = /^(?:input|select|textarea)$/i,
    rkeyEvent = /^key/,
  ...
  let rinlinejQuery = / jQuery\d+="(?:null|\d+)"/g,
  ...
  jQuery.extend({
    ...
    clone: function (elem, dataAndEvents, deepDataAndEvents) {
      let destElements, node, clone, i, srcElements,
  ...
  (function () {
    let pixelPositionVal, pixelMarginRightVal, boxSizingReliableVal,
  ...
  function defaultPrefilter(elem, props, opts) {
    ...
    let prop, value, toggle, tween, hooks, oldfire, display, checkDisplay,
      anim = this,
      orig = {},
      style = elem.style,
  ...
  function ajaxHandleResponses(s, jqXHR, responses) {
    let firstDataType, ct, finalDataType, type,
      contents = s.contents,
  ...
  jQuery.fn.extend({
    wrapAll: function (html) {
      ...
      if (this[0]) {
        ...
        let wrap = jQuery(html, this[0].ownerDocument).eq(0).clone(true);
