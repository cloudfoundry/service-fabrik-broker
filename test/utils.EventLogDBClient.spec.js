...
describe('utils', function () {
  ...
  describe('EventLogDBClient', function () {
    ...
    let subscribeStub, saveStub, eventHandler;

    before(function () {
      subscribeStub = sinon.stub(pubsub, 'subscribe', (eventType, handler) => eventHandler = handler);
      ...
      it('successfully logs event to DB', function () {
        const eventInfo = {
          ...
          request: {
            ...
            operation: 'base64_encodeed_string',
