...
describe('managers', function () {
  describe('RestoreService', function () {
    ...
    describe('#getOperationState', function () {
      let sandbox, getRestoreOperationStateStub;
      ...
      afterEach(function () {
        getRestoreOperationStateStub.restore();
      });

      it('Should get restore state - processing', function () {
        const restoreState = {
          state: 'processing',
          stage: 'Restoring ...',
      ...
      it('Should get restore state - aborted', function () {
        const restoreState = {
          state: CONST.RESTORE_OPERATION.ABORTED,
        };
        getRestoreOperationStateStub = sandbox.stub(RestoreService.prototype,
          'getRestoreOperationState',
          () => Promise.resolve(restoreState)
