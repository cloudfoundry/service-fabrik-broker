    ...
    describe('tasks', function () {
      describe('TaskFabrik', function () {
        ...
        it('returns required task implementation/throws error for unknown task types', () => {
          const ServiceInstanceUpdate = require('../../applications/operators/serviceflow-operator/task/ServiceInstanceUpdateTask');
          const ServiceInstanceBackup = require('../../applications/operators/serviceflow-operator/task/ServiceInstanceBackupTask');
          const BlueprintTask = require('../../applications/operators/serviceflow-operator/task/BlueprintTask');
