...
const cfquotaManager = require('../../quota/cf-platform-quota-manager').cfPlatformQuotaManager;
...
describe('quota', () => {
  describe('CFQuotaManager', () => {
    ...
    describe('checkQuota', () => {
      const QuotaManager = proxyquire('../../quota/cf-platform-quota-manager/CFPlatformQuotaManager.js', {
        '../../common/config': {
          quota: {
            enabled: true,
