...
const PostgresqlService = require('../../operators/postgresql-operator/PostgresqlService');


describe('#PostgresqlService', function () {
  this.timeout(0);
    ...
    describe('Postgresql', function () {
      ...
      describe('#provision', function () {
        it('returns 201 created', function () {
          ...
          mocks.agent.getInfo();
          mocks.postgresqlAgent.createDb(instance_id);
          const options = {
          ...
          mocks.apiServerEventMesh.nockGetResource(CONST.APISERVER.RESOURCE_GROUPS.DEPLOYMENT, CONST.APISERVER.RESOURCE_TYPES.LOGICALDB, instance_id, changeObject);
          ...
          mocks.apiServerEventMesh.nockPatchResource(CONST.APISERVER.RESOURCE_GROUPS.DEPLOYMENT, CONST.APISERVER.RESOURCE_TYPES.LOGICALDB, instance_id, changeObject1);

          return PostgresqlService.createPostgresqlService(instance_id, options)
      ...
      describe('#update', function () {
        it('returns 200 OK', function () {
          ...
          mocks.director.getDeploymentInstances(deployment_name);
          mocks.agent.getInfo();
          mocks.postgresqlAgent.updateDb(instance_id);
          const options = {
            service_id: service_id,
            plan_id: plan_id,
            parameters: parameters,
      ...
      describe('#bind', function () {
        it('returns 201 Created', function () {
          ...
          mocks.director.getDeploymentInstances(deployment_name);
          mocks.agent.getInfo();
          mocks.postgresqlAgent.createCredentials(instance_id);

          mocks.director.createBindingProperty(binding_id, {}, deployment_name, mocks.postgresqlAgent.credentials);
          const options = {
          ...
          mocks.apiServerEventMesh.nockGetResource(CONST.APISERVER.RESOURCE_GROUPS.DEPLOYMENT, CONST.APISERVER.RESOURCE_TYPES.LOGICALDB, instance_id, payload2);

          return PostgresqlService.createPostgresqlService(instance_id, options)
            .then(service => service.bind(options))
            .then(res => {
              expect(res).to.eql(mocks.postgresqlAgent.credentials);
              mocks.verify();
            });
        });
      });
      ...
      describe('#unbind', function () {
        it('returns 200 OK', function () {
          ...
          mocks.director.getDeploymentInstances(deployment_name);
          mocks.agent.getInfo();
          mocks.postgresqlAgent.deleteCredentials(instance_id);
          mocks.director.getBindingProperty(binding_id, {}, deployment_name, false, mocks.postgresqlAgent.credentials);
      ...
      describe('#deprovision', function () {
        it('returns 200 OK', function () {
          ...
          mocks.director.getDeploymentInstances(deployment_name);
          mocks.agent.getInfo();
          mocks.postgresqlAgent.deleteDb(instance_id);
          const options = {
            service_id: service_id,
            plan_id: plan_id,
