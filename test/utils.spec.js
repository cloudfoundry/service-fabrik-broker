...
describe('utils', function () {
  describe('#deploymentNameRegExp', function () {
    ...
    let deployment_name = `${DirectorManager.prefix}_${test_subnet}-5432abcd-1098-abcd-7654-3210abcd9876`;

    it.skip('should match network index', function () {
      expect(utils.deploymentNameRegExp(test_subnet).exec(deployment_name)[2]).to.eql('1234-');
    });
    it('should match guid', function () {
      expect(utils.deploymentNameRegExp(test_subnet).exec(deployment_name)[2]).to.eql('5432abcd-1098-abcd-7654-3210abcd9876');
    });
    ...
    it('should match name and subnet', function () {
      ...
      // removesubnet 
      deployment_name = `${DirectorManager.prefix}-5432abcd-1098-abcd-7654-3210abcd9876`;
