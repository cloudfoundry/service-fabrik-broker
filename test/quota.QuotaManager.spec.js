...
describe('quota', () => {
  describe('QuotaManager', () => {
    ...
    describe('checkQuota', () => {
      ...
      const planName = 'v1.0-dedicated-xsmall';
      ...
      const planId = 'bc158c9a-7934-401e-94ab-057082a5073f';
      const planGuid = 'c77ff479-ea63-42ea-b6d1-d824c4012f1c';
      const planGuids = [planGuid];
      const servicePlans = [{
        'metadata': {
          'guid': 'c77ff479-ea63-42ea-b6d1-d824c4012f1c',
          'url': '/v2/service_plans/c77ff479-ea63-42ea-b6d1-d824c4012f1c',
      ...
      before(function () {
        ...
        getServiceInstancesStub.withArgs(orgId, planGuids).returns(Promise.resolve(serviceInstances));
      ...
      it('returns quota does not exist when quota value is 3 and service instances created in the org is 3', () => {
        ...
        return quotaManager.checkQuota(orgId, planId)
          .then(value => {
